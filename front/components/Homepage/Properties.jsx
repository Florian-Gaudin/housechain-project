        ...
        <Provider store={store}>
            <div className="">
                <div className="reveal-1 text-center">
                    ...
                    <p className="mt-6 pt-6 text-3xl text-bg leading-10 tracking-widest font-bold max-w-[1000px] mx-auto">
                ...
                <div className="reveal-2">
                    <p className="text-center mt-6 pt-6 text-3xl text-bg leading-10 tracking-widest font-bold max-w-[1000px] mx-auto">
